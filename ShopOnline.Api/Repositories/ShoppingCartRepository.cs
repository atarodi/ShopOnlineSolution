...
namespace ShopOnline.Api.Repositories
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        public async Task<CartItem> AddItem(CartItemToAddDto cartItemToAddDto)
        {
            ...
            {
                //product exists in productTable
                //var item2 = this.shopOnlineDbContext.Products.Where(x => x.Id == cartItemToAddDto.ProductId)
                //                 .Select(x => new CartItem { CartId = cartItemToAddDto.CartId, ProductId = x.Id, Qty = cartItemToAddDto.Qty })
